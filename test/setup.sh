...
"${KUBECTL}" wait configuration.pkg configuration-gcp-gke-workload-identity --for=condition=Healthy --timeout 5m
"${KUBECTL}" wait configuration.pkg configuration-gcp-gke-workload-identity --for=condition=Installed --timeout 5m
